...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Section: () => (/* binding */ Section),\n/* harmony export */   createAboutPage: () => (/* binding */ createAboutPage)\n/* harmony export */ });\n/* harmony import */ var _img_pie_jpg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./img/pie.jpg */ \"./src/img/pie.jpg\");\n/* harmony import */ var _img_rool_jpg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./img/rool.jpg */ \"./src/img/rool.jpg\");\n/* harmony import */ var _img_bread_jpg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./img/bread.jpg */ \"./src/img/bread.jpg\");\n\r\n\r\n\r\n\r\n class Section {\r\n    constructor(title, content, imgSrc, rowClass) {\r\n        this.title = title;\r\n        this.content = content;\r\n        this.imgSrc = imgSrc;\r\n        this.rowClass = rowClass;\r\n    }\r\n\r\n    createSection() {\r\n        const rowDiv = document.createElement('div');\r\n        rowDiv.className = `row ${this.rowClass}`;\r\n\r\n        const textDiv = document.createElement('div');\r\n        textDiv.className = 'text';\r\n\r\n        const titleElement = document.createElement(this.rowClass === 'one' ? 'h2' : 'h3');\r\n        titleElement.textContent = this.title;\r\n\r\n        const contentP = document.createElement('p');\r\n        contentP.textContent = this.content;\r\n\r\n        textDiv.appendChild(titleElement);\r\n        textDiv.appendChild(contentP);\r\n\r\n        const imgElement = document.createElement('img');\r\n        imgElement.src = this.imgSrc;\r\n       \r\n\r\n        rowDiv.appendChild(this.rowClass === 'two' ? imgElement : textDiv);\r\n        rowDiv.appendChild(this.rowClass === 'two' ? textDiv : imgElement);\r\n\r\n        return rowDiv;\r\n    }\r\n}\r\n\r\n\r\n\r\nfunction createAboutPage(content) {\r\n    const aboutUsContainer = document.createElement(\"div\");\r\n    aboutUsContainer.className = 'about-us';\r\n    content.appendChild(aboutUsContainer)\r\n\r\n    const sections = [\r\n        new Section('Welcome to Bhako!', 'At Bhako, we believe that every bite should be a delightful experience. Founded in 2015 with a passion for baking and a commitment to quality, Bhako has been serving the community with love and dedication.', `${_img_pie_jpg__WEBPACK_IMPORTED_MODULE_0__}`, 'one'),\r\n        new Section('Our Story', 'Bhako was born out of a desire to create a bakery where tradition meets innovation. Our journey began with a simple idea: to craft the finest baked goods using only the freshest and highest quality ingredients. From our humble beginnings as a small local bakery, we have grown into a beloved establishment known for our delicious pastries, bread, and cakes. ', `${_img_rool_jpg__WEBPACK_IMPORTED_MODULE_1__}`, 'two'),\r\n        new Section('Our Commitment', 'At Bhako, we believe that every bite should be a delightful experience. Founded in 2015 with a passion for baking and a commitment to quality, Bhako has been serving the community with love and dedication.', `${_img_bread_jpg__WEBPACK_IMPORTED_MODULE_2__}`, 'three')\r\n    ];\r\n\r\n    sections.forEach(section => {\r\n        aboutUsContainer.appendChild(section.createSection());\r\n    });\r\n}\r\n\r\n\r\n\n\n//# sourceURL=webpack://resturant-page/./src/AboutUs.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   menuPage: () => (/* binding */ menuPage)\n/* harmony export */ });\n/* harmony import */ var _img_bread_jpg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./img/bread.jpg */ \"./src/img/bread.jpg\");\nconst content = document.getElementById(\"content\")\r\n\r\n;\r\nclass  menuItem {\r\n\r\n    constructor(itemNumber,imgSrc, itemName, price,details) {\r\n       this.itemNumber=itemNumber\r\n        this.imgSrc=imgSrc;\r\n        this.itemName=itemName;\r\n        this.price=price;\r\n        this.details=details;\r\n    }\r\n\r\n   CreateItemCard(){\r\n    \r\n  \r\n    const itemCard= document.createElement(\"div\");\r\n    itemCard.className=`item-card ${this.itemNumber}`\r\n\r\n    const imgELe = document.createElement(\"img\");\r\n    imgELe.src=this.imgSrc;\r\n\r\n    const pricingDiv = document.createElement(\"div\")\r\n    pricingDiv.className=\"pricing\"\r\n\r\n    const h3 =document.createElement(\"h3\");\r\n    h3.textContent=this.itemName;\r\n\r\n    const price =document.createElement(\"p\");\r\n    price.textContent=`Price: $${this.price}`;\r\n\r\n\r\n    pricingDiv.appendChild(h3);\r\n    pricingDiv.appendChild(price);\r\n\r\n\r\n\r\n\r\n    const details =document.createElement(\"p\");\r\n    details.className=\"details\";\r\n    details.textContent=this.details;\r\n\r\n    const Btn =document.createElement(\"button\");\r\n    Btn.textContent=\"Order Now\";\r\n\r\n\r\nitemCard.appendChild(imgELe);\r\nitemCard.appendChild(pricingDiv);\r\nitemCard.appendChild(details);\r\nitemCard.appendChild(Btn);\r\n\r\nreturn itemCard;\r\n\r\n   } \r\n\r\n}\r\n\r\nfunction menuPage(content){\r\n\r\n    \r\n    const Menu = document.createElement(\"div\");\r\n    Menu.className=\"menu\";\r\n\r\n    content.appendChild(Menu);\r\n\r\n    const itemCards = [\r\n        new menuItem(\"One\",`${_img_bread_jpg__WEBPACK_IMPORTED_MODULE_0__}`,\"bread\",\"14.99\",\"loafy hot and tasty bread lorem sdjc efilewv dvhjlsd n eiruevjnv oenfefjbdv mnscmbekef sc,nefkknc\"),\r\n        new menuItem(\"One\",`${_img_bread_jpg__WEBPACK_IMPORTED_MODULE_0__}`,\"bread\",\"14.99\",\"Indulge in the timeless delight of freshly baked loaf bread at our bakery,try for it yourself \"),\r\n        new menuItem(\"One\",`${_img_bread_jpg__WEBPACK_IMPORTED_MODULE_0__}`,\"bread\",\"14.99\",\" Experience the comfort and satisfaction of warm, freshly baked bread with every bite at our bakery.\"),\r\n        new menuItem(\"One\",`${_img_bread_jpg__WEBPACK_IMPORTED_MODULE_0__}`,\"bread\",\"14.99\",\"loafy hot and tasty bread lorem sdjc efilewv dvhjlsd n eiruevjnv oenfefjbdv mnscmbekef sc,nefkknc\"),\r\n        new menuItem(\"One\",`${_img_bread_jpg__WEBPACK_IMPORTED_MODULE_0__}`,\"bread\",\"14.99\",\"loafy hot and tasty bread lorem sdjc efilewv dvhjlsd n eiruevjnv oenfefjbdv mnscmbekef sc,nefkknc\"),\r\n        new menuItem(\"One\",`${_img_bread_jpg__WEBPACK_IMPORTED_MODULE_0__}`,\"bread\",\"14.99\",\"Indulge in the timeless delight of freshly baked loaf bread at our bakery\"),\r\n        new menuItem(\"One\",`${_img_bread_jpg__WEBPACK_IMPORTED_MODULE_0__}`,\"bread\",\"14.99\",\" Experience the comfort and satisfaction of warm, freshly baked bread with every bite at our bakery.\"),\r\n        new menuItem(\"One\",`${_img_bread_jpg__WEBPACK_IMPORTED_MODULE_0__}`,\"bread\",\"14.99\",\"loafy hot and tasty bread lorem sdjc efilewv dvhjlsd n eiruevjnv oenfefjbdv mnscmbekef sc,nefkknc\"),\r\n        new menuItem(\"One\",`${_img_bread_jpg__WEBPACK_IMPORTED_MODULE_0__}`,\"bread\",\"14.99\",\"loafy hot and tasty bread lorem sdjc efilewv dvhjlsd n eiruevjnv oenfefjbdv mnscmbekef sc,nefkknc\"),\r\n        new menuItem(\"One\",`${_img_bread_jpg__WEBPACK_IMPORTED_MODULE_0__}`,\"bread\",\"14.99\",\"loafy hot and tasty bread lorem sdjc efilewv dvhjlsd n eiruevjnv oenfefjbdv mnscmbekef sc,nefkknc\")\r\n    ]\r\n\r\n    itemCards.forEach((ItemCard)=>{\r\n        Menu.appendChild(ItemCard.CreateItemCard());\r\n\r\n    })\r\n    \r\n}\n\n//# sourceURL=webpack://resturant-page/./src/menu_.js?");
